# based on https://github.com/okrasolar/pytorch-timeseries/blob/88f65ad7d2bfdf5bea5c5e3aa1eab90c46b1856b/src/models/inception.py
import torch
...
class InceptionModel(nn.Module):
    ...
    def __init__(self, num_blocks: int, in_channels: int, out_channels: Union[List[int], int],
        ...
        self.final = nn.Sequential(nn.Linear(in_features=channels[-1], out_features=num_pred_classes), nn.Sigmoid())
...
class InceptionBlock(nn.Module):
    ...
    def __init__(self, in_channels: int, out_channels: int,
        ...
        self.conv_layers = nn.Sequential(*[
            nn.Conv1d(in_channels=channels[i], out_channels=channels[i + 1],
